...
const author = 'Coso'/* TODO poner el nombre del usuario logueado abajo */;
...
<template>
    <div class="col" v-if="props.message">
        <div class="card" :class="{ 'bg-success float-start ms-2 me-5': props.message.author === author, 'bg-info float-end me-2 ms-5': props.message.author !== author }">
            <div class="card-body">
                <small class="text-muted">{{ props.message.created_at }}</small>
